...
const TYPES = new Set(["bridge_ping", "project_git_status", "azure_work_item_read",
  "azure_work_item_update", "project_text_search", "project_file_read", "project_comment_replace", "project_git_diff"]);
...
module.exports = { context, putJson, remoteJson, runOnce, watch, runTask, validate, matchesMachine, azureWorkItemUpdate };
